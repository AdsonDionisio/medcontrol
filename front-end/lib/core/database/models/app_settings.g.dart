...
void _appSettingsSerialize(
  ...
  writer.writeLong(offsets[0], object.snoozeMinutes);
}
...
AppSettings _appSettingsDeserialize(
  ...
  object.id = id;
  object.snoozeMinutes = reader.readLong(offsets[0]);
  return object;
}
...
extension AppSettingsQueryFilter
  ...
  snoozeMinutesEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'snoozeMinutes', value: value),
      );
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
  snoozeMinutesGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
  snoozeMinutesLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
